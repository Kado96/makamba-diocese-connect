...
def fix_content():
    ...
    set_img('1934', 'timeline/arrival-1934.png')
    set_img('1960', 'timeline/vintage-church.png')
    set_img('1992', 'timeline/vintage-church.png')
    set_img('2009', 'timeline/creation-2009.png')
