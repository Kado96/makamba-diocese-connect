        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="p-6 bg-slate-50/50 rounded-2xl border border-slate-100 space-y-4">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <div className="space-y-1">
                        <label htmlFor="stat_years_label_rn" className="text-[10px] font-bold text-slate-400">Label (RN)</label>
                        <Input id="stat_years_label_rn" name="stat_years_label_rn" defaultValue={settings?.stat_years_label_rn} className="h-9 text-sm" />
                    </div>
                    <div className="space-y-1">
                    ...
                    <div className="space-y-1">
                        <label htmlFor="stat_years_label_sw" className="text-[10px] font-bold text-slate-400">Label (SW)</label>
                        <Input id="stat_years_label_sw" name="stat_years_label_sw" defaultValue={settings?.stat_years_label_sw} className="h-9 text-sm" />
                    </div>
                </div>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-2">
                    ...
                    <div className="space-y-1">
                        <label htmlFor="stat_years_desc_rn" className="text-[10px] font-bold text-slate-300">Desc (RN)</label>
                        <Input id="stat_years_desc_rn" name="stat_years_desc_rn" defaultValue={settings?.stat_years_desc_rn} className="h-8 text-[10px]" />
                    </div>
                    <div className="space-y-1">
                    ...
                    <div className="space-y-1">
                        <label htmlFor="stat_years_desc_sw" className="text-[10px] font-bold text-slate-300">Desc (SW)</label>
                        <Input id="stat_years_desc_sw" name="stat_years_desc_sw" defaultValue={settings?.stat_years_desc_sw} className="h-8 text-[10px]" />
                    </div>
                </div>
            </div>
            ...
            <div className="p-6 bg-slate-50/50 rounded-2xl border border-slate-100 space-y-4">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <div className="space-y-1">
                        <label htmlFor="stat_emissions_rn" className="text-[10px] font-bold text-slate-400">Label (RN)</label>
                        <Input id="stat_emissions_rn" name="stat_emissions_rn" defaultValue={settings?.stat_emissions_rn} className="h-9 text-sm" />
                    </div>
                    <div className="space-y-1">
                    ...
                    <div className="space-y-1">
                        <label htmlFor="stat_emissions_sw" className="text-[10px] font-bold text-slate-400">Label (SW)</label>
                        <Input id="stat_emissions_sw" name="stat_emissions_sw" defaultValue={settings?.stat_emissions_sw} className="h-9 text-sm" />
                    </div>
                </div>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-2">
                    <div className="space-y-1">
                    ...
                    <div className="space-y-1">
                        <label htmlFor="stat_emissions_desc_rn" className="text-[10px] font-bold text-slate-300">Desc (RN)</label>
                        <Input id="stat_emissions_desc_rn" name="stat_emissions_desc_rn" defaultValue={settings?.stat_emissions_desc_rn} className="h-8 text-[10px]" />
                    </div>
                    <div className="space-y-1">
                    ...
                    <div className="space-y-1">
                        <label htmlFor="stat_emissions_desc_sw" className="text-[10px] font-bold text-slate-300">Desc (SW)</label>
                        <Input id="stat_emissions_desc_sw" name="stat_emissions_desc_sw" defaultValue={settings?.stat_emissions_desc_sw} className="h-8 text-[10px]" />
                    </div>
                </div>
            </div>
            ...
            {/* Audience */}
            <div className="p-6 bg-slate-50/50 rounded-2xl border border-slate-100 space-y-4">
                <h3 className="font-bold text-slate-900 border-b pb-2">{t('admin_stat_audience_title', "Fidèles / Audience")}</h3>
                <div className="space-y-2">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <div className="space-y-1">
                        <label htmlFor="stat_audience_rn" className="text-[10px] font-bold text-slate-400">Label (RN)</label>
                        <Input id="stat_audience_rn" name="stat_audience_rn" defaultValue={settings?.stat_audience_rn} className="h-9 text-sm" />
                    </div>
                    <div className="space-y-1">
                    ...
                    <div className="space-y-1">
                        <label htmlFor="stat_audience_sw" className="text-[10px] font-bold text-slate-400">Label (SW)</label>
                        <Input id="stat_audience_sw" name="stat_audience_sw" defaultValue={settings?.stat_audience_sw} className="h-9 text-sm" />
                    </div>
                </div>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-2">
                    <div className="space-y-1">
                    ...
                    <div className="space-y-1">
                        <label htmlFor="stat_audience_desc_rn" className="text-[10px] font-bold text-slate-300">Desc (RN)</label>
                        <Input id="stat_audience_desc_rn" name="stat_audience_desc_rn" defaultValue={settings?.stat_audience_desc_rn} className="h-8 text-[10px]" />
                    </div>
                    <div className="space-y-1">
                    ...
                    <div className="space-y-1">
                        <label htmlFor="stat_audience_desc_sw" className="text-[10px] font-bold text-slate-300">Desc (SW)</label>
                        <Input id="stat_audience_desc_sw" name="stat_audience_desc_sw" defaultValue={settings?.stat_audience_desc_sw} className="h-8 text-[10px]" />
                    </div>
                </div>
            </div>
            ...
            {/* Langues */}
            <div className="p-6 bg-slate-50/50 rounded-2xl border border-slate-100 space-y-4">
                <h3 className="font-bold text-slate-900 border-b pb-2">{t('admin_stat_languages_title', "Thématiques / Paroisses")}</h3>
                <div className="space-y-2">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <div className="space-y-1">
                        <label htmlFor="stat_languages_rn" className="text-[10px] font-bold text-slate-400">Label (RN)</label>
                        <Input id="stat_languages_rn" name="stat_languages_rn" defaultValue={settings?.stat_languages_rn} className="h-9 text-sm" />
                    </div>
                    <div className="space-y-1">
                    ...
                    <div className="space-y-1">
                        <label htmlFor="stat_languages_sw" className="text-[10px] font-bold text-slate-400">Label (SW)</label>
                        <Input id="stat_languages_sw" name="stat_languages_sw" defaultValue={settings?.stat_languages_sw} className="h-9 text-sm" />
                    </div>
                </div>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-2">
                    <div className="space-y-1">
                    ...
                    <div className="space-y-1">
                        <label htmlFor="stat_languages_desc_rn" className="text-[10px] font-bold text-slate-300">Desc (RN)</label>
                        <Input id="stat_languages_desc_rn" name="stat_languages_desc_rn" defaultValue={settings?.stat_languages_desc_rn} className="h-8 text-[10px]" />
                    </div>
                    <div className="space-y-1">
                        <label htmlFor="stat_languages_desc_en" className="text-[10px] font-bold text-slate-300">Desc (EN)</label>
                        <Input id="stat_languages_desc_en" name="stat_languages_desc_en" defaultValue={settings?.stat_languages_desc_en} className="h-8 text-[10px]" />
                    </div>
                    <div className="space-y-1">
                        <label htmlFor="stat_languages_desc_sw" className="text-[10px] font-bold text-slate-300">Desc (SW)</label>
                        <Input id="stat_languages_desc_sw" name="stat_languages_desc_sw" defaultValue={settings?.stat_languages_desc_sw} className="h-8 text-[10px]" />
                    </div>
                </div>
            </div>
        </div>
